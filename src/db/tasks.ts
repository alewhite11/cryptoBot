...
export const dailyTasks : Task[] = [
  ...
  {title: 'Like our X post',text: 'Like our X post, it will take just a second!', image: xImg, link: 'https://x.com/The_Plant_Token/status/1827340486811521399', channelId: '', type: 'openAndClaim', id: 24},
